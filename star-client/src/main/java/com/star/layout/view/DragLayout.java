...
/**
 * 侧滑布局
 * @ClassName: DragLayout.java 
 * @Description: 侧滑菜单中使用的布局
 * @author Lee
 * @email lijunlong42@126.com  
 * @date 2014-12-24 上午11:56:05
 */
public class DragLayout extends FrameLayout {
    ...
    private void animateView(float percent) {
        ...
        //getBackground().setColorFilter(evaluate(percent, R.drawable.bg, Color.TRANSPARENT), Mode.SRC_OVER);
    }
