...
public class ZhangHaoActivity extends BaseActivity implements OnClickListener {
	...
	private Button back;
	private TextView name, id, starOner,edit;
	...
	void initView() {
		...
		edit = (TextView) this.findViewById(R.id.zhanghao_edit);
	}
	...
	public void onClick(View v) {
		...
		case R.id.zhanghao_online:
			...
			break;
		case R.id.zhanghao_edit:
			Intent edit = new Intent(this, FillDetailsActivity.class);
			startActivity(edit);
			break;
		}
	}
