...
public class MyListview extends ListView implements OnScrollListener, OnClickListener
{
	...
	private void init(Context context)
	{
		...
		headView = (LinearLayout) inflater.inflate(R.layout.layout_tongxunlu_head, null);
		...
		footerView = (LinearLayout) inflater.inflate(R.layout.layout_tongxunlu_footer, null);
